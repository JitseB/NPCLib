package com.bnstra.npclib.nms.v1_18_R1.packets;
...
public class PacketPlayOutEntityMetadataWrapper {
    ...
    public PacketPlayOutEntityMetadata create(Collection<NPCState> activateStates, int entityId) {
        ...
        dataWatcher.a(new DataWatcherObject<EntityPose>(6, DataWatcherRegistry.s), getMaskedPose(activateStates));
        dataWatcher.a(new DataWatcherObject<>(0, DataWatcherRegistry.a), masked);

package com.bnstra.npclib.nms.v1_17_R1;

import com.bnstra.npclib.nms.v1_17_R1.packets.*;
...
public class NPC_v1_17_R1 extends NPCBase {
    ...
    public NPC_v1_17_R1(NPCLib instance, List<String> lines) {
        super(instance, lines, MinecraftVersion.V1_17_R1);
    }
    ...
    public void sendShowPackets(Player player) {
        ...
        if (hasTeamRegistered.add(player.getUniqueId()))
            Arrays.stream(packetPlayOutScoreboardTeam).forEach(playerConnection::sendPacket);

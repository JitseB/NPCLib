...
public class NPC_v1_8_R2 extends NPC {
    ...
    public NPC_v1_8_R2(JavaPlugin plugin, Skin skin, double autoHideDistance, List<String> lines, List<ItemStack> equipment) {
        ...
        if(equipment != null) {
            for (int i = 0; i < equipment.size(); i++) {
                if(equipment.get(i) != null) {
                    this.packetPlayOutEntityEquipment.add(new PacketPlayOutEntityEquipment(getEntityId(), i, CraftItemStack.asNMSCopy(equipment.get(i))));
                }
            }
        }

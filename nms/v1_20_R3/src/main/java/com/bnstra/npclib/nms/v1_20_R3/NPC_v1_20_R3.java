package com.bnstra.npclib.nms.v1_20_R3;

import com.bnstra.npclib.nms.v1_20_R3.packets.*;
 ...
 */
public class NPC_v1_20_R3 extends NPCBase {
    ...
    public NPC_v1_20_R3(NPCLib instance, List<String> lines) {
        super(instance, lines, MinecraftVersion.V1_20_R3);
    }
    ...
    public void sendShowPackets(Player player) {
        ...
        if (hasTeamRegistered.add(player.getUniqueId())) {
            for (PacketPlayOutScoreboardTeam scoreboardPacket : packetPlayOutScoreboardTeam)
                playerConnection.a(scoreboardPacket, null);
        }
        playerConnection.a(packetPlayOutPlayerInfoAdd, null);
        playerConnection.a(packetPlayOutSpawnEntity, null);
        playerConnection.a(packetPlayOutEntityHeadRotation, null);
        playerConnection.a(packetPlayOutEntityMetadata, null);
        ...
        playerInfoRemoveTimers.put(player.getUniqueId(), Bukkit.getScheduler().runTaskLater(instance.getPlugin(), () -> {
            if (isShown(player)) {
                playerConnection.a(packetPlayOutPlayerInfoRemove, null);
            }
    ...
    public void sendHidePackets(Player player) {
        ...
        playerConnection.a(packetPlayOutEntityDestroy, null);
        playerConnection.a(packetPlayOutPlayerInfoRemove, null);
    ...
    public void sendMetadataPacket(Player player) {
        ...
        playerConnection.a(packet, null);
    }
    ...
    public void sendHeadRotationPackets(Location location) {
        for (UUID shownUuid : super.getShown()) {
            ...
            if (player != null && isShown(player)) {
                ...
                connection.a(new PacketPlayOutEntity.PacketPlayOutEntityLook(entityId,
                        (byte) ((yaw % 360.) * 256 / 360),
                        (byte) ((pitch % 360.) * 256 / 360), false), null);
                connection.a(new PacketPlayOutEntityHeadRotationWrapper()
                        .create(npcLocation, entityId), null);
            }
        }
    }
}

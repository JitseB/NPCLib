...
package com.bnstra.npclib.nms.v1_8_R3;

import com.bnstra.npclib.nms.v1_8_R3.packets.*;
...
public class NPC_v1_8_R3 extends NPCBase {
    ...
    public NPC_v1_8_R3(NPCLib instance, List<String> lines) {
        super(instance, lines, MinecraftVersion.V1_8_R3);
    }
    ...
    public void updateSkin(Skin skin) {
        ...
        for (UUID shownUuid : super.getShown()) {
            ...
            if (player != null && isShown(player)) {
                ...
                // TODO: It is not necessary to resend the hologram packets, exclude these

package com.bnstra.npclib.nms.v1_19_R2.packets;
...
public class PacketPlayOutEntityMetadataWrapper {
    ...
    public PacketPlayOutEntityMetadata create(Collection<NPCState> activateStates, int entityId) {
        ...
        Arrays.asList(
                DataWatcher.b.a(new DataWatcherObject<>(17, DataWatcherRegistry.a), (byte) 127),
                DataWatcher.b.a(new DataWatcherObject<EntityPose>(6, DataWatcherRegistry.u),
                    getMaskedPose(activateStates)),
                DataWatcher.b.a(new DataWatcherObject<>(0, DataWatcherRegistry.a), masked)
                )
        );
    }

...
package com.bnstra.npclib;

import com.bnstra.npclib.NPCLibOptions.MovementHandling;
import com.bnstra.npclib.api.NPC;
import com.bnstra.npclib.api.utilities.Logger;
import com.bnstra.npclib.listeners.*;
import com.bnstra.npclib.metrics.NPCLibMetrics;
...
public final class NPCLib {
    ...
    private NPCLib(JavaPlugin plugin, MovementHandling moveHandling) {
        ...
        try {
            this.npcClass = Class.forName("com.bnstra.npclib.nms." + versionName + ".NPC_" + versionName);
